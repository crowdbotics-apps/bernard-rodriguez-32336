...
## Project Structure
    ...
    ├── bernard_rodriguez_32336  # Django project configurations
...
1. Clone this repo and `cd bernard_rodriguez_32336`
...
2. Clone this repo and `cd bernard_rodriguez_32336`
